...
class Functions {
    ...
    function getJcropImage( $properties, $controlador_id=0, $foto_id=0 ){
    	...
    	if( $foto_id>0 ){
    		...
    		//Si la imagen no está subida, pero ya se creó el objeto (producto,artículo, etc) doy la opción de cargarla
    		if( $controlador_id>0 ){
    		...
    		//Si no muestro un mensaje
    			...
    			$html = '<p style="margin-top:10px;">Para poder cargar una imagen primero grabá.</p>';
