<?php
/* Vista para precios invernada
*  Agrego botón para editar comentario
*/
 ...
 <div id="wrapper">
    <div id="content">
		...
		<div class="lista_acciones-gral">
			...
			<?php echo $boton_csv; ?>
            <?php echo $boton_xml; ?>
			<?php echo '<a class="boton" href="'.base_url().'precios_invernada_comentario/edit/1">Editar comentario</a>' ?>
        </div>
    </div>
</div>
