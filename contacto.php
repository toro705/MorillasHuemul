...
?>
	...
	<section id="contacto" class="banda bg-1">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-lg-6 col-md-offset-1 col-lg-offset-2">
						<?php include('includes/forms/contacto.php'); ?>
						...
						<form id="contact-form" class="form-horizontal" role="form" method="post">
						  ...
						  <div class="form-group">
						    <div class="col-sm-9 col-sm-offset-3 text-center">
						      <button type="submit" name="enviar_contacto" class="btn btn-azul"><?=$txt[SECCION][8] ?></button>
						    </div>
						  </div>
						</form>
						<?php } ?>							
				...
				<a class="tel-contacto" href="tel:<?= Empresa::$telefono_enlace ?>">
					<i class="icn icn-telefono-circle"></i>
					<p class="h2 contacto-texto"><?=$txt[SECCION][9] ?></p>
					<p class="h2 contacto-telefono"><?= Empresa::$telefono ?></p>
